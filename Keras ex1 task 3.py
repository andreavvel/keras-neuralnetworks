...
def preprocess_input_image(img_path):
    img = image.load_img(img_path, target_size=(28, 28), grayscale=True)  # Load the image and resize to 28x28 grayscale
...
img_path = r'path_to_your_image.jpg'  # Replace 'path_to_your_image.jpg' with the actual path to your image
